...
class KalmanFilterTracker:
    ...
    def update(self, bbox, frame=None):
        ...
        if dist > 1.0:
            ...
            self.x[2, 0] = dist # update velocity estimate
...
class BoundingBoxTracker:
    ...
    def update(self, detections, frame=None, already_updated_ids=None):
        ...
        for i, track in enumerate(self.tracks):
            ...
            if is_matched or track.time_since_update < self.max_lost_frames:
